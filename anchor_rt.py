...
def load_polarity(path='notebooks/rt-polaritydata'):
    data = []
    labels = []
...
train, test, train_labels, test_labels = sklearn.model_selection. \
    train_test_split(data, labels, test_size=.2, random_state=42)
train, val, train_labels, val_labels = sklearn.model_selection. \
    train_test_split(train, train_labels, test_size=.1, random_state=42)
